...
We have ambitious plans for the future of MeridianAlgo. Here is what's on our horizon for 2026 and beyond.
...
- **MeridianAlgo Cloud**: A hosted platform for running and monitoring institutional-grade trading bots.
- **Distributed Backtesting**: Scale simulations across a cluster of Node.js workers.

---

Have a feature request? [Open an issue](https://github.com/MeridianAlgo/Javascript-Packages/issues)!
